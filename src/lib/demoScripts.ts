...
const faith: Scenario = {
    ...
    script: [
        ...
        {
            role: 'user',
            text: 'He did warn me. I’ll tell you now, I’ve never been much of a talker.',
            delay: 2200,
        },
        ...
        {
            role: 'user',
            text: 'My mother’s. St Brigid’s, six o’clock Mass, before her shift at the laundry. She went every morning of her life. Even the winter she wouldn’t look at Father Dolan.',
            delay: 2700,
        },
        ...
        {
            role: 'user',
            text: 'My brother Thomas. He was born in the February and he lived four days. He wasn’t baptised in time, so they wouldn’t have him inside the churchyard. My father buried him himself, outside the wall, under the hawthorn.',
            delay: 3000,
        },
        ...
        {
            role: 'user',
            text: 'The back of everybody’s heads. She’d always sat near the front, and after Thomas she took us right to the back, by the door. She never missed a morning. She just wouldn’t take Communion, and she wouldn’t look at him.',
            delay: 3000,
        },
        ...
        {
            role: 'user',
            text: 'The two of them together. And I’d tell her they moved the wall. That’s all. I’d just want her to know they moved the wall.',
            delay: 3000,
        },
    ...
    family: [
        {
            kind: 'edit',
            name: 'Marco',
            text: 'was invited and can edit this archive. He found the parish register and put Thomas’s four dates into it.',
        },
        {
            kind: 'add',
            name: 'Her cousin Pia',
            text: 'sent a photograph of the hawthorn through the contribute link. No account, no app, nothing to sign up for.',
            pending: 'Waiting for Rosa',
        },
    ],
...
const childhood: Scenario = {
    ...
    script: [
        ...
        {
            role: 'user',
            text: 'She’s been on at me about this for a month. Go on then.',
            delay: 2100,
        },
        ...
        {
            role: 'user',
            text: 'A blue enamel jug on a windowsill. Don’t ask me why.',
            delay: 2200,
        },
        ...
        {
            role: 'user',
            text: 'Bread, mostly. My aunt Vera baked every other day. That was the year my mother was in the sanatorium, so it was Vera doing it.',
            delay: 2700,
        },
        ...
        {
            role: 'user',
            text: 'Vera. She had four of her own and she took me as a fifth, no discussion about it. Up at six, the fire, the bread. And she walked me to school the long way round, so we wouldn’t have to go past the hospital gate.',
            delay: 3000,
        },
        ...
        {
            role: 'user',
            text: 'They’d stop the second I came in. And they were forever saying she was “doing very well”. I’d worked out what that meant by about the third month. Nobody tells a child a person is doing very well unless the other thing is on the table.',
            delay: 3100,
        },
        ...
        {
            role: 'user',
            text: '…It was tuberculosis. You may as well put it down properly, now we’re here.',
            delay: 2800,
        },
    ...
    family: [
        ...
        },
        {
            kind: 'add',
            name: 'His cousin Ray',
            text: 'is one of Vera’s four, and sent his own account of the same year through the contribute link.',
            pending: 'Waiting for Errol',
        },
    ],
...
const love: Scenario = {
    ...
    script: [
        ...
        {
            role: 'user',
            text: 'Paul says I’m to talk about his father. I’ll try. I’m not sure where you start with fifty-one years.',
            delay: 2400,
        },
        ...
        {
            role: 'user',
            text: 'I put it on the fire. Nineteen seventy-one. It was the one where he asked me to marry him, and that year I couldn’t have it in the house.',
            delay: 2900,
        },
        ...
        {
            role: 'user',
            text: 'Top of the wardrobe in the back bedroom. Paul’s old room. I get it down twice a year, about. I don’t read them. I just check they’re still there.',
            delay: 2900,
        },
        ...
        {
            role: 'user',
            text: 'When he died I went through the house, and her name is on the back of every photograph in it. Every single one. In that handwriting. He’d been writing it down where I wouldn’t see. All those years. Because he couldn’t get it out of his mouth.',
            delay: 3400,
        },
        {
            role: 'user',
            text: 'He couldn’t say mine either. I’d had that wrong for fifty-one years as well.',
            delay: 2900,
        },
    ...
    family: [
        {
            kind: 'edit',
            name: 'Paul',
            text: 'was invited and can edit this archive. He added Susan’s two dates, and a photograph of the back of one of them.',
        },
        {
            kind: 'add',
