 ...
 */
export const DEPTHS = [
    { level: 1, name: 'Warm-up', blurb: 'Easy to answer on a bad day. Where did you live? Who else was in the house?' },
    { level: 2, name: 'Scene', blurb: 'One afternoon, in detail. What was on the table, and who was talking over whom.' },
    { level: 3, name: 'Portrait', blurb: 'A person, drawn properly. What your father was like when nobody was watching.' },
    { level: 4, name: 'Stakes', blurb: 'What it cost. The choice that was hard, and what you gave up to make it.' },
    { level: 5, name: 'Reckoning', blurb: 'What you would say now. The apology, the pride, the thing never said out loud.' },
];
