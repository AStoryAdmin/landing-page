...
import { color, font, motion, radius, shadow, space, tracking, type, weight } from '../styles/theme';
...
export const PageQuote = styled.p`
    ...
    font-size: clamp(0.8125rem, 0.65rem + 0.8vw, 1.125rem);
    line-height: 1.55;
    text-align: center;
    color: ${color.body};
    overflow: hidden;
...
export const PageButton = styled.button`
    ...
    &:hover:not(:disabled) { background: ${color.primaryWash}; border-color: ${color.primary}; }
...
export const PageCount = styled.p`
    ...
    /* The album always sits on a dark section. */
