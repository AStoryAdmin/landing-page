...
export const SummaryPanel = styled.aside`
    ...
    li svg { color: ${color.goldText}; margin-top: 4px; }
    li strong { color: ${color.onDark}; font-weight: ${weight.semibold}; }
...
export const TocEntry = styled.li<{ $active: boolean }>`
    ...
    a {
        ...
        border-left: 2px solid ${({ $active }) => ($active ? color.accent : color.primaryLine)};
        font-size: ${type.xs};
        line-height: 1.45;
